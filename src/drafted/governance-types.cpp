...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SarosNetwork") type = SarosNetwork;
    if(strType == "SarosNetworkVariable") type = SarosNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SarosNetwork) s = "SarosNetwork";
    if(type == SarosNetworkVariable) s = "SarosNetworkVariable";
