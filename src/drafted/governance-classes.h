 ...
 *
 *   // network
 *   CSarosNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.saros.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSarosNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SarosNetwork
// //   -- signature requirements : Key1(User)
// class CSarosNetworkVariable : public CGovernanceObject
// {
// private:
