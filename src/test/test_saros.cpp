...
#define BOOST_TEST_MODULE Saros Test Suite

#include "test_saros.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_saros_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
