    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Saros Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Saros Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  saros-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Saros in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SAROS, 0.1 SAROS, 1 SAROS and 10 SAROS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://sarospay.atlassian.net/wiki/display/DOC/PrivateSend\">https://sarospay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Saros Core is shutting down...") + "<br /><br />" +
