...
Only requiring some minor changes is saros.cpp.
...
Changes to saros.cpp
----------------------
saros.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
