...
This mechanism has been integrated into Bitcore-Node-Saros which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sarospay/insight-api-saros#web-socket-api](https://github.com/sarospay/insight-api-saros#web-socket-api)
* API: [https://github.com/sarospay/insight-api-saros#instantsend-transactions](https://github.com/sarospay/insight-api-saros#instantsend-transactions)
...
By default, the Saros Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Saros Core daemon:
